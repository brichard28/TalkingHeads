# -*- coding: utf-8 -*-
"""
Created on Wed Aug  9 17:17:38 2023
...
if not os.path.exists("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID):
    os.mkdir("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID)
...
all_sentences_F2 = [];
num_trials=12
possible_conditions = ["mismatch left","mismatch right"]
...
for itrial in range(num_trials):
    ...
    if flips==0:                               # F1 on left and F2 on right
        ...
        if  condition_this_trial == 'mismatch left':  #mismatch left condition
    ...
    if flips==1:                     # F2 on left and F1 on right
        ...
        if  condition_this_trial == 'mismatch left': #mismatch left 
            audio1_spatialized = audio1_spatialized[1] # indexing in to dictionary 
 ...
 # Generating Videos
    ...
    if flips==0:  # F1 on left and F2 on right
        ...
        audioclip = AudioFileClip("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\sentence_1_spatialized.wav") # reading audio clip
        ...
        audioclip = AudioFileClip("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\sentence_2_spatialized.wav") # reading audio clip
   ...
   #Adding visual cues and audio cues    
    ...
    if condition_this_trial == 'mismatch right':
    ...
    combined_with_cue.write_videofile("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "_trial_" + str(itrial) + "_cond_ " + str(condition_this_trial) + ".mp4") # Writing the video


pandas.DataFrame(all_sentences_F1).to_csv("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "all_sentences_F1.csv") #  Creating CSv for F1 Sentences
pandas.DataFrame(all_sentences_F2).to_csv("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "all_sentences_F2.csv") #  Creating CSv for F2 Sentences
pandas.DataFrame(condition_array).to_csv("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "all_conditions.csv") #  Creating CSV all conditions

df1=pandas.read_csv("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "all_conditions.csv") #reading all conditions
df2=pandas.read_csv("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "all_sentences_F1.csv") # Reading F1 sentences
df3=pandas.read_csv("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "all_sentences_F2.csv") # Reading F2 sentences
...
df.to_csv("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "Answerkey.csv")