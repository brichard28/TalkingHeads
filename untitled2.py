...
df = pd.DataFrame({
    'subject Id': ['pilot002', '419_pilot2', '419_pilot3', '419_pilot4'],
    'matched right': [93.33333333, 91.66666667, 78.33333333, 91.66666667],
    'matched left': [90, 98.33333333, 93.33333333, 100],
    'mismatched right': [56.66666667, 80, 66.66666667, 98.33333333],
    'mismatched left': [88.33333333, 93.33333333, 80, 100]
})
...
df2= pd.DataFrame({
    'subject Id': ['pilot002', '419_pilot2', '419_pilot3', '419_pilot4'],
    'matched cases':[91.66666667,95,85.83333333,95.83333333],
    'mismatched cases':[72.5,86.66666667,73.33333333,99.16666667]
    })
