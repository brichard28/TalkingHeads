...
right_answer= pandas.read_csv("D:\\Experiments\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "Answerkey.csv")
...
label = tk.Label(textbox, text="Mismatched condition Practice block")
...
conditions_data_frame = pandas.read_csv("D:\\Experiments\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "all_conditions.csv")
...
while itrial < n_trials:
    ...
    # Present Video
    filename = "D:\\Experiments\\TalkingHeads\\stim\\practice\\mm_" + SubID + "\\" + SubID + "_trial_" + str(itrial) + "_cond_ " + str(condition_this_trial) + ".mp4"
