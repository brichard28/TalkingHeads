# -*- coding: utf-8 -*-
"""
Created on Thu Aug 10 08:54:53 2023
...
right_answer= pandas.read_csv("D:\\Experiments\\TalkingHeads\\stim\\practice\\m_" + SubID + "\\" + SubID + "Answerkey.csv")
...
label = tk.Label(textbox, text="Matched condition Practice block")
...
conditions_data_frame = pandas.read_csv("D:\\Experiments\\TalkingHeads\\stim\\practice\\m_" + SubID + "\\" + SubID + "all_conditions.csv")
...
while itrial < n_trials:
    ...
    # Present Video
    filename = "D:\\Experiments\\TalkingHeads\\stim\\practice\\m_" + SubID + "\\" + SubID + "_trial_" + str(itrial) + "_cond_ " + str(condition_this_trial) + ".mp4"
