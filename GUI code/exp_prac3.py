# -*- coding: utf-8 -*-
"""
Created on Thu Aug 10 09:09:10 2023
...
right_answer= pandas.read_csv("D:\\Experiments\\TalkingHeads\\stim\\practice\\all_" + SubID + "\\" + SubID + "Answerkey.csv")
...
label = tk.Label(textbox, text="All condition Practice block")
...
conditions_data_frame = pandas.read_csv("D:\\Experiments\\TalkingHeads\\stim\\practice\\all_" + SubID + "\\" + SubID + "all_conditions.csv")
...
while itrial < n_trials:
    ...
    # Present Video
    filename = "D:\\Experiments\\TalkingHeads\\stim\\practice\\all_" + SubID + "\\" + SubID + "_trial_" + str(itrial) + "_cond_ " + str(condition_this_trial) + ".mp4"
