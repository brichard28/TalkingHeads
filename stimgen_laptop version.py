...
for itrial in range(num_trials):
    ...
    audio1_spatialized = spatialize_seq(audio1_dict,0,0.0005,fs_1) #Spatializing audio to both directions (ITD)
    audio2_spatialized = spatialize_seq(audio2_dict,0,0.0005,fs_2) #Spatializing audio to both directions (ITD)
 ...
 # Generating Videos
   ...
   #Adding visual cues and audio cues    
    if condition_this_trial == 'match right':  
        ...
        if flips==0: # F1 on left and F2 on right
            audioclip_right_match=AudioFileClip("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\Audio Cue\\Houses_F2_matchedright_ramped.wav")
           # audioclip_right_match= audioclip_right_match.subclip(0,right_cue.duration)
            right_cue= right_cue.set_audio(audioclip_right_match)
        
            combined_with_cue = CompositeVideoClip([right_cue, # starts at t=0
                                combined.set_start(2.5)]) # start at t=1s
            x_position =  20
            ...
            audioclip_right_match=AudioFileClip("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\Audio Cue\\Chairs_F1_matchedright_ramped.wav")
            #audioclip_right_match= audioclip_right_match.subclip(0,right_cue.duration)
            right_cue= right_cue.set_audio(audioclip_right_match)
        ...
        right_cue_color=ImageSequenceClip(["colored_blocks_white.png"], durations = [0.004])
        if flips==0: # F1 on left and F2 on right
            audioclip_right_match=AudioFileClip("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\Audio Cue\\Houses_F2_mismatchedright_ramped.wav")
            #audioclip_right_match= audioclip_right_match.subclip(0,right_cue.duration)
            right_cue= right_cue.set_audio(audioclip_right_match)
            combined_with_cue = CompositeVideoClip([right_cue, # starts at t=0
                                combined.set_start(2.5)]) # start at t=1s
        ...
        if flips==0: # F1 on left and F2 on right
            audioclip_left_match=AudioFileClip("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\Audio Cue\\Chairs_F1_matchedleft_ramped.wav")
            #audioclip_left_match= audioclip_left_match.subclip(0,left_cue.duration)
            ...
            audioclip_left_match=AudioFileClip("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\Audio Cue\\Houses_F2_matchedleft_ramped.wav")
            #audioclip_left_match= audioclip_left_match.subclip(0,left_cue.duration)
            left_cue= left_cue.set_audio(audioclip_left_match)
            combined_with_cue = CompositeVideoClip([left_cue, # starts at t=0
                                combined.set_start(2.5)]) # start at t=1s
        ...
        if flips==0: # F1 on left and F2 on right
            ...
            audioclip_left_match=AudioFileClip("C:\\Users\\maana\\Documents\\GitHub\\TalkingHeads\\stim\\Audio Cue\\Houses_F2_mismatchedleft_ramped.wav")
           # audioclip_left_match= audioclip_left_match.subclip(0,left_cue.duration)
            left_cue= left_cue.set_audio(audioclip_left_match)
            combined_with_cue = CompositeVideoClip([left_cue,  # starts at t=0
                            combined.set_start(2.5)])  # start at t=1s
